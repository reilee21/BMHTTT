...
"}")
        ...
        self.btn_openregis.setGeometry(QtCore.QRect(320, 340, 200, 35))
        font = QtGui.QFont()
...
"border-radius: 10px;")
        ...
        self.btn_forgotpass = QtWidgets.QPushButton(parent=Dialog)
        self.btn_forgotpass.setGeometry(QtCore.QRect(390, 240, 200, 35))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setUnderline(False)
        self.btn_forgotpass.setFont(font)
        self.btn_forgotpass.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.btn_forgotpass.setStyleSheet("color: rgb(85, 170, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btn_openregis.setText(_translate("Dialog", "Bạn chưa có tài khoản ? "))
        ...
        self.btn_forgotpass.setText(_translate("Dialog", "Quên mật khẩu ?"))
